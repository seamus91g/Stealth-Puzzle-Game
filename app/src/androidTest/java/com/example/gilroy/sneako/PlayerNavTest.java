...
public class PlayerNavTest {
    ...
    public void setUp() throws Exception {
        ...
        level = new LevelConstructs(new GameSetup().wallmatrix, tileDimension);
        Context appContext = InstrumentationRegistry.getTargetContext();
        player = new PlayerSprite(level.getInsertionPoint(), tileDimension, appContext.getResources());
        player2 = new PlayerSprite(level.getNode(1, 0), tileDimension, appContext.getResources());
    }
